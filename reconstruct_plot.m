function [x] = reconstruct_plot(f_fitness,f_constr,opts)
...
options = optimoptions('ga','ConstraintTolerance',1e-6,'FunctionTolerance',1e-10,...
    'PlotFcn', {@gaplotbestf, @gaplotmaxconstr},'MaxGenerations',150,'MaxTime',Inf,'CrossoverFraction',0.9,'UseParallel',true);
tic
